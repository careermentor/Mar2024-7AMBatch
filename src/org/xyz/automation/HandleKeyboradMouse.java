...
public class HandleKeyboradMouse 
{
	WebDriver driver;
	...
	public void handleAlerts() throws Exception
	{
			...
			CaptureScreenshot.evidence(driver,"handleAlerts");
	}
